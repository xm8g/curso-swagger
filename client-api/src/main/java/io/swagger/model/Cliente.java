...
public class Cliente   {
  ...
  private OffsetDateTime dataAtualizacaoRegistro = null;
...
@Size(min=2,max=7) 
  ...
  **/
  ...
  public Cliente dataAtualizacaoRegistro(OffsetDateTime dataAtualizacaoRegistro) {
    this.dataAtualizacaoRegistro = dataAtualizacaoRegistro;
    return this;
  }

  /**
   * Get dataAtualizacaoRegistro
  ...
  **/
  ...
  public OffsetDateTime getDataAtualizacaoRegistro() {
    return dataAtualizacaoRegistro;
  }

  public void setDataAtualizacaoRegistro(OffsetDateTime dataAtualizacaoRegistro) {
    this.dataAtualizacaoRegistro = dataAtualizacaoRegistro;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Ativo ou Inativo")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, cliente.id) &&
        ...
        Objects.equals(this.dataAtualizacaoRegistro, cliente.dataAtualizacaoRegistro) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, nome, sobrenome, iniciais, dataNascimento, dataAtualizacaoRegistro, status, tipo);
  }
  ...
  public String toString() {
    ...
    sb.append("    dataAtualizacaoRegistro: ").append(toIndentedString(dataAtualizacaoRegistro)).append("\n");
